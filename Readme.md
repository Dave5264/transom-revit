...
### ⬇ [Download the installer](https://github.com/Dave5264/transom-revit/releases/download/v1.9.17/Transom-1.9.17-SingleUser.msi)
...
> **Status:** v1.9.17 (Revit 2025/2026/2027) moves AIRE to OpenAI's new **GPT Image 2.5** models and makes
> its price honest. The estimate now follows the Quality setting, which it never did, and every finished
> image records what OpenAI actually billed in the CSV log. The three image models OpenAI is retiring are
> gone, and a saved one is moved across with an explanation. Before it, v1.9.16 put the standalone AIRE app
> in the firm-wide installer, v1.9.15 gave AIRE the **Video tab** described above, and earlier releases
> brought a **prompt library, saved API keys and a pop-out editor** (v1.9.14), **AIRE as a standalone app**
